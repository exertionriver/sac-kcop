...
object RenderEarthLocationTags {
    ...
    fun setContent() {
        ...
        DVLayoutHandler.currentDvLayout.setTextPaneContent("eltLeftTag", SACInputProcessor.locationRecallStateMachine.currentState.getLabels()[1], SACLayoutHandler.baseValuesFontColor)
        ...
        if (!SACInputProcessor.locationRecallStateMachine.isInState(LocationRecallState.CUR_NAV_REF)) {
            ...
            DVLayoutHandler.currentDvLayout.setTextPaneContent("eltRightTag", SACInputProcessor.locationRecallStateMachine.currentState.getLabels()[3], SACLayoutHandler.baseValuesFontColor)
