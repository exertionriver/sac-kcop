...
object RenderSummaryConAnSumRefImp : IConsoleRender {
    ...
    override fun setContent() {
        ...
        val natalChartValue = SACComponent.refNatValueChart.getBaseValue() + SACComponent.refNatValueChart.getModValue()
        val layoutPanes = setLayout().panes

        DVLayoutHandler.currentDvLayout.setTextPaneContent(layoutPanes[0].tag!!, RenderChartState.getChartSumLabel().impConAmChartLabel(), SACLayoutHandler.refEarthLocationFontColor)
