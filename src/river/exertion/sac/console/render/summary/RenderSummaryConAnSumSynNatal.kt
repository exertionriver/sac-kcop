...
object RenderSummaryConAnSumSynNatal : IConsoleRender {
    ...
    override fun setContent() {
        val chartValue = RenderValue(SACComponent.synNatValueChart.getBaseValue() + SACComponent.synNatValueChart.getModValue())
        val layoutPanes = setLayout().panes

        DVLayoutHandler.currentDvLayout.setTextPaneContent(layoutPanes[0].tag!!, RenderChartState.getChartSumLabel().conAmChartLabel(), SACLayoutHandler.synEarthLocationFontColor)
