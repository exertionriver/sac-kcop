...
import river.exertion.sac.astro.render.RenderChartState.conAmChartLabel
...
object RenderSummaryConAnSumChart : IConsoleRender {

    override val layoutTag = "summaryConAnSumChart"
    ...
    override fun setContent() {
        val chartValue = RenderValue(SACComponent.sacValueChart.getBaseValue() + SACComponent.sacValueChart.getModValue())
        val layoutPanes = setLayout().panes

        DVLayoutHandler.currentDvLayout.setTextPaneContent(layoutPanes[0].tag!!, RenderChartState.getChartSumLabel().conAmChartLabel(), SACLayoutHandler.baseValuesFontColor)
