...
object RenderSummaryConAnSumRefNatal : IConsoleRender {
    ...
    override fun setContent() {
        val chartValue = RenderValue(SACComponent.refNatValueChart.getBaseValue() + SACComponent.refNatValueChart.getModValue())
        val layoutPanes = setLayout().panes

        DVLayoutHandler.currentDvLayout.setTextPaneContent(layoutPanes[0].tag!!, RenderChartState.getChartSumLabel().conAmChartLabel(), SACLayoutHandler.refEarthLocationFontColor)
